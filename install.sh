...
apt-get -y update
apt-get -y upgrade
apt -y install libcurl4-openssl-dev libjansson-dev libomp-dev git screen nano jq wget
...
wget https://raw.githubusercontent.com/saengx/Android-Mining/main/config.json -P ~/ccminer
